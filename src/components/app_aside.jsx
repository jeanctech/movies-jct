...
function App_Aside() {
  return (
    <>
      <div
        id="app_row"
        className="m-1 p-1 bg-[#232136] text-[#fffaf3] flex flex-[80%] flex-col justify-start items-baseline rounded-lg"
      >
        ...
        <div>
          ...
          >
            <h3
              id="app_div_row"
              className="m-1.5 p-1.5 font-500 flex flex-row flex-start bg-[#2a273f] text-[#f6c177] rounded-lg cursor-pointer hover:text-[#a2cce7] font-bold"
            >
              Generos
            </h3>
            <span
              id="app_div_row"
              className="m-1.5 p-1.5 font-500 flex flex-row flex-end bg-[#2a273f] text-[#eb6f92] rounded-lg cursor-pointer hover:text-[#a2cce7] font-bold"
            >
              Ver Todos
            </span>
          </div>
