        ...
        <div>
          ...
          <ul className="m-1 p-1 flex flex-row justify-center items-center flex-wrap">
            <a href="https://reactjs.dev">
              <img
                src="https://pelisimg.online/cover/blue-beetle-1692423798.png"
                id="img"
            ...
            <a href="https://reactjs.dev">
              <img
                src="https://pelisimg.online/cover/mission-impossible-dead-reckoning-part-one-1689741889.png"
                id="img"
                className="m-1 p-1 flex-row flex-wrap rounded-xl border-y-2 border-x-2 border-[#5e5a5a]"
                alt="React-Logo"
                width={160}
            ...
            <a href="https://reactjs.dev">
              <img
                src="https://pelisimg.online/cover/indiana-jones-and-the-dial-of-destiny-1692519533.png"
                id="img"
                className="m-1 p-1 flex-row flex-wrap rounded-xl border-y-2 border-x-2 border-[#5e5a5a]"
                alt="React-Logo"
                width={160}
            ...
            <a href="https://reactjs.dev">
              <img
                src="https://pelisimg.online/cover/transformers-rise-of-the-beasts-2-1686267601.jpg"
                id="img"
                className="m-1 p-1 flex-row flex-wrap rounded-xl border-y-2 border-x-2 border-[#5e5a5a]"
                alt="React-Logo"
                width={160}
            ...
            <a href="https://reactjs.dev">
              <img
                src="https://pelisimg.online/cover/spider-man-across-the-spider-se-2-1685731801.jpg"
                id="img"
                className="m-1 p-1 flex-row flex-wrap rounded-xl border-y-2 border-x-2 border-[#5e5a5a]"
                alt="React-Logo"
                width={160}
            ...
            <a href="https://reactjs.dev">
              <img
                src="https://pelisimg.online/cover/fast-x-2-1684533003.jpg"
                id="img"
                className="m-1 p-1 flex-row flex-wrap rounded-xl border-y-2 border-x-2 border-[#5e5a5a]"
                alt="React-Logo"
                width={160}
            ...
            <a href="https://reactjs.dev">
              <img
                src="https://pelisimg.online/cover/guardians-of-the-galaxy-volume-3-2-1683243601.jpg"
                id="img"
                className="m-1 p-1 flex-row flex-wrap rounded-xl border-y-2 border-x-2 border-[#5e5a5a]"
                alt="React-Logo"
                width={160}
            ...
            <a href="https://reactjs.dev">
              <img
                src="https://pelisimg.online/cover/the-flash-2023-1691552507.png"
                id="img"
                className="m-1 p-1 flex-row flex-wrap rounded-xl border-y-2 border-x-2 border-[#5e5a5a]"
                alt="React-Logo"
                width={160}
            ...
            <a href="https://reactjs.dev">
              <img
                src="https://pelisimg.online/cover/megalodon-2-el-gran-abismo-1691205314.png"
                id="img"
                className="m-1 p-1 flex-row flex-wrap rounded-xl border-y-2 border-x-2 border-[#5e5a5a]"
                alt="React-Logo"
                width={160}
            ...
            <a href="https://reactjs.dev">
              <img
                src="https://pelisimg.online/cover/saw-x-1695976461.png"
                id="img"
                className="m-1 p-1 flex-row flex-wrap rounded-xl border-y-2 border-x-2 border-[#5e5a5a]"
                alt="React-Logo"
                width={160}
